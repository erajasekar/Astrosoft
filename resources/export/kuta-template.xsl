...
xmlns:fo="http://www.w3.org/1999/XSL/Format" exclude-result-prefixes="fo">	
	...
	<xsl:template match="Kuta-Analysis">
		...
		<fo:table width="500pt" margin-top="10" table-layout="fixed" padding-left="20pt">
			...
			<fo:table-cell>
				<fo:block>
					...
					<fo:table width="300pt" margin-top="10" table-layout="fixed" border-color="lightgray" border-left-style="solid" border-top-style="solid" margin-left="5pt"  >
			
				<fo:table-header> <fo:table-row height="17pt" >
		
					<xsl:for-each select="Kuta-Match[1]/child::node()" >
				...
				<fo:table-body > 
						...
						<xsl:for-each select="Kuta-Match" >
