...
public class StaxProcessor {
	...
	private static final Logger log = getLogger(StaxProcessor.class.getName());
	
	private static final XMLEventFactory xmlef = newInstance();
	...
	public static void main(String[] args) {
		...
		try {
			...
			XMLOutputFactory factory = newInstance();
			
            try (Writer out = new BufferedWriter(new FileWriter("c:/astrosoft/export/astrosoft.xml"))) {
